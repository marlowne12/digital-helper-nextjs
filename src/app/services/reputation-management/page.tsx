...
export default function ReputationManagementPage() {
    ...
    const handleQuickAudit = (e: React.FormEvent) => {
        ...
        if (businessName.trim()) {
            // Pass the name to the dashboard via query param or just redirect
            // For now, simpler redirect, user re-types or we could implement context later.
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="max-w-4xl mb-24 mx-auto text-center">
                    ...
                    >
                        ...
                        {/* Quick Audit Input */}
                        <form onSubmit={handleQuickAudit} className="max-w-md mx-auto relative group">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {[
                            ...
                            <motion.div
                                ...
                                className="glass p-8 group hover:border-accent-cyan/20 transition-all"
                            >
                ...
                <section className="mb-32">
                    <div className="glass p-1 rounded-[2.5rem] relative overflow-hidden">
                        ...
                        <div className="relative z-10 p-12 md:p-20 grid lg:grid-cols-2 gap-12 items-center">
                            ...
                            {/* Visual representation of a 5-star review card or graph */}
