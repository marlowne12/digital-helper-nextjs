            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <section className="mb-32">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="glass p-8 aspect-square flex items-center justify-center relative overflow-hidden group">
                ...
                <section id="pricing" className="mb-32">
                    ...
                    <div className="glass overflow-hidden max-w-2xl mx-auto">
                        <table className="w-full text-left">
                            <thead>
                                <tr className="border-b border-white/[0.08] bg-white/[0.02]">
                                    <th className="p-6 text-white font-semibold">Industry</th>
                            ...
                            <tbody>
                                {industries.map((industry, index) => (
                                    <tr key={industry.name} className="border-b border-white/[0.08] last:border-0 hover:bg-white/[0.02] transition-colors">
                                        ...
                                        <td className="p-6 text-right font-mono text-accent-purple">{industry.price}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
