    ...
    return (
        <>
            <IndustryServiceSchema
                ...
                description="Empowering Tri-Cities agriculture and agribusiness with modern digital solutions. Specialized web design and SEO for farms, suppliers, and processing facilities."
                url="https://digital-helper.com/industries/agriculture"
                audience="Agribusinesses, farms, and food processing companies in the Tri-Cities region"
            />
            <BreadcrumbSchema
                items={[
                    { name: "Home", url: "https://digital-helper.com" },
                    { name: "Industries", url: "https://digital-helper.com/industries" },
                    { name: "Agriculture", url: "https://digital-helper.com/industries/agriculture" },
                ]}
            />
            <IndustryPageContent
                industry="Agriculture"
