    ...
    return (
        <>
            <LocalBusinessCitySchema
                city="Kennewick"
                description="Driving growth for Kennewick businesses with conversion-focused web design and local SEO. Get found first on Columbia Center Blvd and beyond with Digital Helper."
                url="https://digital-helper.com/locations/kennewick"
            />
            <BreadcrumbSchema
                items={[
                    { name: "Home", url: "https://digital-helper.com" },
                    { name: "Locations", url: "https://digital-helper.com/locations" },
                    { name: "Kennewick", url: "https://digital-helper.com/locations/kennewick" },
                ]}
            />
            <LocationPageContent
                city="Kennewick"
