    ...
    return (
        <>
            <LocalBusinessCitySchema
                city="Richland"
                description="Richland's premier partner for high-performance web design and local SEO. We help Richland businesses dominate search results and scale with AI automation."
                url="https://digital-helper.com/locations/richland"
            />
            <BreadcrumbSchema
                items={[
                    { name: "Home", url: "https://digital-helper.com" },
                    { name: "Locations", url: "https://digital-helper.com/locations" },
                    { name: "Richland", url: "https://digital-helper.com/locations/richland" },
                ]}
            />
            <LocationPageContent
                city="Richland"
