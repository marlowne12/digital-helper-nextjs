        ...
        <main className="min-h-screen pt-32 pb-20 overflow-hidden bg-background-primary">
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="max-w-4xl mb-24">
                    ...
                    >
                        <span className="flex items-center gap-2 text-accent-purple text-sm font-medium mb-6">
                ...
                <section className="mb-32">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="glass p-10 relative">
                            <div className="absolute -top-6 -left-6 w-20 h-20 bg-accent-purple/20 rounded-full blur-2xl" />
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        {values.map((value, index) => (
                            <motion.div
                                ...
                                className="glass p-8 group border-transparent hover:border-accent-purple/20 transition-all duration-300"
                            >
                ...
                {/* Final CTA */}
                <section className="relative py-20 rounded-3xl overflow-hidden glass text-center px-6">
