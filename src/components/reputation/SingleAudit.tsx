...
export default function SingleAudit({ initialQuery }: SingleAuditProps) {
  ...
  return (
    <div className="container mx-auto max-w-7xl px-4 py-8 space-y-12 bg-[#0a0a0f] min-h-screen relative">
      ...
      {profile && audit && (
        ...
        >
          ...
          {/* Header Info */}
          <div className="flex flex-col md:flex-row gap-6 items-start justify-between bg-white/[0.03] border border-white/[0.08] p-8 rounded-2xl relative overflow-hidden group">
            ...
            <div className="space-y-3 relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-6 text-zinc-400 text-sm">
                <div className="flex items-center gap-2"><MapPin className="w-4 h-4 text-indigo-300"/> {profile.address}</div>
            ...
            <div className="flex flex-col gap-3 text-sm text-right relative z-10 w-full md:w-auto">
              ...
              {profile.phone && (
                <div className="bg-white/[0.03] border border-white/[0.08] px-4 py-2 rounded-lg flex items-center justify-center md:justify-end gap-2 text-zinc-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white/[0.03] border border-white/[0.08] p-6 rounded-2xl relative overflow-hidden">
            ...
            <div className="lg:col-span-2 space-y-8">
              <section>
                <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
                  <span className="w-8 h-8 rounded-lg bg-indigo-600/20 flex items-center justify-center text-accent-purple text-sm">01</span>
                  Strategic Analysis
                </h3>
              ...
              <section>
                <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
                  <span className="w-8 h-8 rounded-lg bg-accent-indigo/20 flex items-center justify-center text-indigo-300 text-sm">02</span>
                  Action Items
