    ...
    <div className="w-full max-w-3xl mx-auto text-center space-y-8">
      <div className="space-y-4">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-600/10 border border-indigo-500/20 text-accent-purple text-xs font-medium uppercase tracking-wider"
        >
      ...
      <form onSubmit={handleSubmit} className="relative group max-w-2xl mx-auto">
        <div className="relative flex items-center p-2 bg-charcoal border border-steel/40 rounded-full transition-colors focus-within:border-accent-purple/50">
          ...
          <Button
            ...
            className="h-12 px-8 rounded-full bg-indigo-600 hover:bg-indigo-500 text-white font-semibold"
          >
            {isLoading ? (
              <>
