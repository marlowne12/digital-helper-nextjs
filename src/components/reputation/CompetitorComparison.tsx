...
export default function CompetitorComparison({
  ...
  if (!analysis && !isLoading) {
    return (
      <div className="bg-white/[0.03] border border-white/[0.08] p-8 rounded-2xl text-center space-y-4 relative overflow-hidden group">
  ...
  if (isLoading) {
    return (
      <div className="bg-white/[0.03] border border-white/[0.08] p-12 rounded-2xl flex flex-col items-center justify-center space-y-4">
    ...
    <div className="space-y-8">
      ...
      {analysis && (
        <div className="grid gap-6">
          ...
          <div className="bg-white/[0.03] border border-white/[0.08] p-6 rounded-xl border-l-4 border-accent-cyan">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {analysis.competitors.map((comp, idx) => (
              <motion.div
                ...
                className="bg-white/[0.03] border border-white/[0.08] p-5 rounded-xl flex flex-col h-full"
              >
          ...
          {/* Recommendations */}
          <div className="bg-white/[0.03] border border-white/[0.08] p-6 rounded-xl">
