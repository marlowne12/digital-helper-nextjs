...
export default function ActionCard({ recommendation }: ActionCardProps) {
  ...
  return (
    <div className="bg-white/[0.03] border border-white/[0.08] p-6 rounded-2xl group border-white/5 hover:border-indigo-500/30 transition-all duration-300">
      <div className="flex flex-col md:flex-row items-start justify-between gap-6">
        ...
        <div className="flex-shrink-0 pt-2">
          <Button
            ...
            className={result ? "bg-white/10 text-white hover:bg-white/20 border border-white/10" : "bg-indigo-600 hover:bg-indigo-500 text-white font-semibold"}
            size="sm"
          >
            {isProcessing ? (
              <>
