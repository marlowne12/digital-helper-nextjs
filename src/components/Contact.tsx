                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-start">
                        ...
                        <div>
                            ...
                            <div className="space-y-6">
                                <a href="tel:+15098768454" className="flex items-center gap-4 group">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-white font-semibold group-hover:text-cyan-400 transition-colors">(509) 876-8454</span>
                                    </div>
                                </a>

                                <a href="mailto:business@digital-helper.com" className="flex items-center gap-4 group">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-white font-semibold group-hover:text-purple-400 transition-colors">business@digital-helper.com</span>
                                    </div>
                                </a>
                                ...
                                <div className="flex items-center gap-4 group">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-slate-500">Serving the entire Tri-Cities</p>
                                    </div>
                                </div>
