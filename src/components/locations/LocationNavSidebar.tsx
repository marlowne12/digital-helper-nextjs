...
export function LocationNavSidebar() {
  ...
  return (
    <aside className="hidden lg:block w-full sticky top-32 self-start space-y-8">
                ...
                `}>
                  <div className="flex items-center gap-3">
                    <span className={`
                      ...
                      ${isActive ?'bg-accent-primary/20 text-indigo-400':'bg-white/5 text-zinc-500 group-hover:text-white'}
                    `}>
                      {location.icon}
                    </span>
      ...
      <div className="bg-white/[0.03] border border-white/[0.08] p-6 rounded-2xl border border-accent-primary/20 bg-accent-primary/5 relative overflow-hidden group">
