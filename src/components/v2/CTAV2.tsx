      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-8 py-4 min-h-[44px] rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-base transition-all duration-200 hover:shadow-xl hover:shadow-indigo-500/30 group"
            >
              Book Your Free Demo
