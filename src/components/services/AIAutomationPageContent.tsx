            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-32 pb-24 relative">
                ...
                <section className="mb-32">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        <div className="bg-charcoal p-8 rounded-3xl border border-white/10 hover:border-white/20 transition-all flex flex-col">
                        ...
                        <div className="bg-charcoal p-8 rounded-3xl border border-signal-amber/40 relative flex flex-col">
                            <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 bg-signal-amber text-operator-black font-bold text-xs rounded-full uppercase tracking-tighter">Growth</div>
