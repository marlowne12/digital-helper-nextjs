        ...
        >
            ...
            <section className="mb-24">
                <div className="grid md:grid-cols-2 gap-6">
                    <StatisticCard
                        ...
                        description="Implementing AI chatbots can reduce customer service operational costs by up to 30%."
                        source="IBM"
                        delay={0.2}
                    />
                    <StatisticCard
                        value="40%"
                        label="Time Saved"
                        description="About 40% of time spent on sales activities can be automated with current technology."
                        source="McKinsey"
                        delay={0.3}
                    />
                </div>
            ...
            <section className="mb-24">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="glass p-1 rounded-[2.5rem] relative group overflow-hidden order-2 lg:order-1">
            ...
            <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="text-center bg-accent-indigo/5 border border-accent-indigo/10 p-12 rounded-[2.5rem]"
            >
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Automate or Be Automated.</h2>
