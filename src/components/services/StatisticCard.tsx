...
export function StatisticCard({ value, label, description, source, delay = 0 }: StatisticCardProps) {
  return (
    <motion.div
      ...
      className="bg-white/[0.03] border border-white/[0.08] p-6 rounded-2xl border border-white/5 relative group hover:border-indigo-500/20 transition-all duration-300"
    >
