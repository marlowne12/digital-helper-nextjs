...
export function ServiceNavSidebar() {
  ...
  return (
    <aside className="hidden lg:block w-full sticky top-32 self-start space-y-8">
                ...
                `}>
                  <div className="flex items-center gap-3">
                    <span className={`
                      ...
                      ${isActive ?'bg-indigo-600/20 text-accent-purple':'bg-white/5 text-zinc-500 group-hover:text-white'}
                    `}>
                      {service.icon}
                    </span>
      ...
      <div className="bg-white/[0.03] border border-white/[0.08] p-6 rounded-2xl border border-indigo-500/20 bg-indigo-500/5 relative overflow-hidden group">
